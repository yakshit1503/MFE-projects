...
function a(s, t) { return { type: n.Trigger, name: s, definitions: t, options: {} }; }
function c(s, t = null) { return { type: n.Animate, styles: t, timings: s }; }
function y(s, t = null) { return { type: n.Group, steps: s, options: t }; }
function F(s, t = null) { return { type: n.Sequence, steps: s, options: t }; }
function S(s) { return { type: n.Style, styles: s, offset: null }; }
function g(s, t, e) { return { type: n.State, name: s, styles: t, options: e }; }
function D(s) { return { type: n.Keyframes, steps: s }; }
function d(s, t, e = null) { return { type: n.Transition, expr: s, animation: t, options: e }; }
function p(s, t = null) { return { type: n.Reference, animation: s, options: t }; }
function E(s = null) { return { type: n.AnimateChild, options: s }; }
function P(s, t = null) { return { type: n.AnimateRef, animation: s, options: t }; }
function m(s, t, e = null) { return { type: n.Query, selector: s, animation: t, options: e }; }
function C(s, t) { return { type: n.Stagger, timings: s, animation: t }; }
var l = class {
    _onDoneFns = [];
    _onStartFns = [];
    _onDestroyFns = [];
    ...
    parentPlayer = null;
    totalTime;
    constructor(t = 0, e = 0) { this.totalTime = t + e; }
    ...
    triggerCallback(t) { let e = t == "start" ? this._onStartFns : this._onDoneFns; e.forEach(r => r()), e.length = 0; }
}, u = class {
    _onDoneFns = [];
    _onStartFns = [];
    _finished = !1;
    ...
    totalTime = 0;
    players;
    constructor(t) { this.players = t; let e = 0, r = 0, o = 0, h = this.players.length; h == 0 ? queueMicrotask(() => this._onFinish()) : this.players.forEach(i => { i.onDone(() => { ++e == h && this._onFinish(); }), i.onDestroy(() => { ++r == h && this._onDestroy(); }), i.onStart(() => { ++o == h && this._onStart(); }); }), this.totalTime = this.players.reduce((i, f) => Math.max(i, f.totalTime), 0); }
    _onFinish() { this._finished || (this._finished = !0, this._onDoneFns.forEach(t => t()), this._onDoneFns = []); }
    ...
    setPosition(t) { let e = t * this.totalTime; this.players.forEach(r => { let o = r.totalTime ? Math.min(1, e / r.totalTime) : 1; r.setPosition(o); }); }
    getPosition() { let t = this.players.reduce((e, r) => e === null || r.totalTime > e.totalTime ? r : e, null); return t != null ? t.getPosition() : 0; }
    beforeDestroy() { this.players.forEach(t => { t.beforeDestroy && t.beforeDestroy(); }); }
    triggerCallback(t) { let e = t == "start" ? this._onStartFns : this._onDoneFns; e.forEach(r => r()), e.length = 0; }
}, k = "!";
export { n as a, _ as b, a as c, c as d, y as e, F as f, S as g, g as h, D as i, d as j, p as k, E as l, P as m, m as n, C as o, l as p, u as q, k as r };
