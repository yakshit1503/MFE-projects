...
function fe(t) { return Mr(t) ? t : zn(t) ? G(Promise.resolve(t)) : v(t); }
function Lr(t) { return Mr(t) ? rt(t) : Promise.resolve(t); }
var hi = { exact: jr, subset: kr }, xr = { exact: fi, subset: pi, ignored: () => !0 }, tr = { paths: "exact", fragment: "ignored", matrixParams: "ignored", queryParams: "exact" }, je = { paths: "subset", fragment: "ignored", matrixParams: "ignored", queryParams: "subset" };
function rr(t, n, e) { let r = t instanceof T ? t : n.parseUrl(t); return Fn(() => kt(n.lastSuccessfulNavigation()?.finalUrl ?? new T, r, l(l({}, je), e))); }
function kt(t, n, e) { return hi[e.paths](t.root, n.root, e.matrixParams) && xr[e.queryParams](t.queryParams, n.queryParams) && !(e.fragment === "exact" && t.fragment !== n.fragment); }
function fi(t, n) { return W(t, n); }
function jr(t, n, e) { if (!ce(t.segments, n.segments) || !Xe(t.segments, n.segments, e) || t.numberOfChildren !== n.numberOfChildren)
    ...
    if (!t.children[r] || !jr(t.children[r], n.children[r], e))
        return !1; return !0; }
function pi(t, n) { return Object.keys(n).length <= Object.keys(t).length && Object.keys(n).every(e => Pr(t[e], n[e])); }
...
var T = class {
    ...
    toString() { return Fr(this); }
};
function gi(t, n) { return ce(t, n) && t.every((e, r) => W(e.parameters, n[r].parameters)); }
function ce(t, n) { return t.length !== n.length ? !1 : t.every((e, r) => e.path === n[r].path); }
function vi(t, n) { let e = []; return Object.entries(t.children).forEach(([r, i]) => { r === p && (e = e.concat(n(i, r))); }), Object.entries(t.children).forEach(([r, i]) => { r !== p && (e = e.concat(n(i, r))); }), e; }
var ie = (() => { class t {
...
function Sr(t) { return tt(t.replace(/\+/g, "%20")); }
function Fr(t) { return `${$t(t.path)}${Ri(t.parameters)}`; }
function Ri(t) { return Object.entries(t).map(([n, e]) => `;${$t(n)}=${$t(e)}`).join(""); }
...
var Si = /^[^\/()?;#]+/;
function _t(t) { let n = t.match(Si); return n ? n[0] : ""; }
var wi = /^[^\/()?;=#]+/;
function bi(t) { let n = t.match(wi); return n ? n[0] : ""; }
var Ii = /^[^=?&#]+/;
function Ei(t) { let n = t.match(Ii); return n ? n[0] : ""; }
var Ai = /^[^&#]+/;
function Mi(t) { let n = t.match(Ai); return n ? n[0] : ""; }
var zt = class {
    url;
    remaining;
    ...
    parseQueryParam(n) { let e = Ei(this.remaining); if (!e)
        return; this.capture(e); let r = ""; if (this.consumeOptional("=")) {
        let s = Mi(this.remaining);
        s && (r = s, this.capture(r));
    } let i = Sr(e), o = Sr(r); if (n.hasOwnProperty(i)) {
        let s = n[i];
...
function qr(t) { return t.segments.length > 0 ? new m([], { [p]: t }) : t; }
function Hr(t) { let n = {}; for (let [r, i] of Object.entries(t.children)) {
    let o = Hr(i);
...
} let e = new m(t.segments, n); return Ti(e); }
...
var it = class {
    ...
    constructor(n, e, r) { if (this.isAbsolute = n, this.numberOfDoubleDots = e, this.commands = r, n && r.length > 0 && nt(r[0]))
        throw new A(4003, !1); let i = r.find(ke); if (i && i !== di(r))
        throw new A(4004, !1); }
...
function _i(t, n, e) { let r = t, i = n, o = e; for (; o > i;) {
    if (o -= i, r = r.parent, !r)
        throw new A(4005, !1);
    i = r.segments.length;
...
function Pi(t) { let n = {}; return Object.entries(t).forEach(([e, r]) => { typeof r == "string" && (r = [r]), r !== null && (n[e] = Ft(new m([], {}), 0, r)); }), n; }
...
function Li(t) { return !(t instanceof de) && !(t instanceof be) && !(t instanceof we); }
var gt = class {
    rootInjector;
    outlet = null;
    route = null;
...
function Bt(t, n) { let e = W(t.params, n.params) && gi(t.url, n.url), r = !t.parent != !n.parent; return e && !r && (!t.parent || Bt(t.parent, n.parent)); }
...
function ji(t, n, e) { let r = qe(t, n._root, e ? e._root : void 0); return new ze(r, n); }
function qe(t, n, e) { if (e && t.shouldReuseRoute(n.value, e.value.snapshot)) {
    let r = e.value;
    ...
    if (t.shouldAttach(n.value)) {
        ...
        if (o !== null) {
            let s = o.route;
            return s.value._futureSnapshot = n.value, s.children = n.children.map(a => qe(t, a)), s;
        }
    }
...
function ki(t, n, e) { return n.children.map(r => { for (let i of e.children)
    if (t.shouldReuseRoute(r.value, i.value.snapshot))
        return qe(t, r, i); return qe(t, r); }); }
function $i(t) { return new Q(new z(t.url), new z(t.params), new z(t.queryParams), new z(t.fragment), new z(t.data), t.outlet, t.component, t); }
var Ee = class {
    redirectTo;
    navigationBehaviorOptions;
...
function zi(t) { return tn(t) && te(t.url); }
...
function Me(t, n) { let e = Symbol(), r = n.get(t, e); return r === e ? typeof t == "function" && !Gn(t) ? t : n.get(t) : r; }
function _e(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) { let o = ve(n); return t.children.forEach(s => { Hi(s, o[s.value.outlet], e, r.concat([s.value]), i), delete o[s.value.outlet]; }), Object.entries(o).forEach(([s, a]) => Pe(a, e.getContext(s), i)), i; }
function Hi(t, n, e, r, i = { canDeactivateChecks: [], canActivateChecks: [] }) { let o = t.value, s = n ? n.value : null, a = e ? e.getContext(t.value.outlet) : null; if (s && o.routeConfig === s.routeConfig) {
...
function Gi(t) { return t && Ge(t.canLoad); }
function Wi(t) { return t && Ge(t.canActivate); }
function Qi(t) { return t && Ge(t.canActivateChild); }
function Ki(t) { return t && Ge(t.canDeactivate); }
...
function no(t, n) { let e = n.routeConfig ? n.routeConfig.canActivate : null; if (!e || e.length === 0)
    return v(!0); let r = e.map(i => er(() => { let o = n._environmentInjector, s = Me(i, o), a = Wi(s) ? s.canActivate(n, t) : L(o, () => s(n, t)); return fe(a).pipe(he()); })); return v(r).pipe(Ae()); }
function io(t, n) { let e = n[n.length - 1], i = n.slice(0, n.length - 1).reverse().map(o => qi(o)).filter(o => o !== null).map(o => er(() => { let s = o.guards.map(a => { let c = o.node._environmentInjector, u = Me(a, c), h = Qi(u) ? u.canActivateChild(e, t) : L(c, () => u(e, t)); return fe(h).pipe(he()); }); return v(s).pipe(Ae()); })); return v(i).pipe(Ae()); }
function oo(t, n, e, r) { let i = n && n.routeConfig ? n.routeConfig.canDeactivate : null; if (!i || i.length === 0)
    return v(!0); let o = i.map(s => { let a = n._environmentInjector, c = Me(s, a), u = Ki(c) ? c.canDeactivate(t, n, e, r) : L(a, () => c(t, n, e, r)); return fe(u).pipe(he()); }); return v(o).pipe(Ae()); }
...
function co(t) { throw new A(4e3, !1); }
function uo(t) { throw en(!1, b.GuardRejected); }
var Wt = class {
    urlSerializer;
    urlTree;
    ...
    applyRedirectCommands(n, e, r, i, o) { return R(this, null, function* () { let s = yield lo(e, i, o); if (s instanceof T)
        throw new He(s); let a = this.applyRedirectCreateUrlTree(s, this.urlSerializer.parse(s), n, r); if (s[0] === "/")
        throw new He(a); return a; }); }
...
function ho(t, n) { return t.providers && !t._injector && (t._injector = Wn(t.providers, n, `Route: ${t.path}`)), t._injector ?? n; }
function F(t) { return t.outlet || p; }
function fo(t, n) { let e = t.filter(r => F(r) === n); return e.push(...t.filter(r => F(r) !== n)), e; }
...
function vo(t, n) { let e = {}; e[p] = n; for (let r of t)
    if (r.path === "" && F(r) !== p) {
        let i = new m([], {});
        e[F(r)] = i;
    } return e; }
function mo(t, n, e, r) { return e.some(i => !Ct(t, n, i) || !(F(i) !== p) ? !1 : !(r !== void 0 && F(i) === r)); }
function yo(t, n, e) { return e.some(r => Ct(t, n, r)); }
...
var So = 31, Yt = class {
    ...
    processSegmentAgainstRoute(n, e, r, i, o, s, a, c) { return R(this, null, function* () { if (F(r) !== s && (s === p || !Ct(i, o, r)))
    ...
    expandSegmentAgainstRouteUsingRedirect(n, e, r, i, o, s, a) { return R(this, null, function* () { let { matched: c, parameters: u, consumedSegments: h, positionalParamSegments: f, remainingSegments: S } = cn(e, i, o); if (!c)
        throw new Y(e); typeof i.redirectTo == "string" && i.redirectTo[0] === "/" && (this.absoluteRedirectCount++, this.absoluteRedirectCount > So && (this.allowRedirects = !1)); let K = this.createSnapshot(n, i, o, u, a); if (this.abortSignal.aborted)
        throw new Error(this.abortSignal.reason); let j = yield this.applyRedirects.applyRedirectCommands(h, i.redirectTo, f, sn(K), n), I = yield this.applyRedirects.lineralizeSegments(i, j); return this.processSegment(n, r, e, I.concat(S), s, !1, a); }); }
    createSnapshot(n, e, r, i, o) { let s = new Ie(r, i, Object.freeze(l({}, this.urlTree.queryParams)), this.urlTree.fragment, Io(e), F(e), e.component ?? e._loadedComponent ?? null, e, Eo(e), n), a = ir(s, o, this.paramsInheritanceStrategy); return s.params = Object.freeze(a.params), s.data = Object.freeze(a.data), s; }
    ...
    getChildConfig(n, e, r) { return R(this, null, function* () { if (e.children)
        ...
        if (yield rt(ao(n, e, r, this.urlSerializer, this.abortSignal))) {
...
function wo(t) { t.sort((n, e) => n.value.outlet === p ? -1 : e.value.outlet === p ? 1 : n.value.outlet.localeCompare(e.value.outlet)); }
...
function Ao(t, n, e, r, i, o, s) { return ue(a => R(null, null, function* () { let { state: c, tree: u } = yield Co(t, n, e, r, a.extractedUrl, i, o, s); return E(l({}, a), { targetSnapshot: c, urlAfterRedirects: u }); })); }
function Mo(t) { return ue(n => { let { targetSnapshot: e, guards: { canActivateChecks: r } } = n; if (!r.length)
...
function hn(t, n, e, r) { return R(this, null, function* () { let i = yield Lr(L(e, () => t.loadChildren())), o = yield pn(fn(i)), s; o instanceof Kn || Array.isArray(o) ? s = o : s = yield n.compileModuleAsync(o), r && r(t); let a, c, u = !1, h; return Array.isArray(s) ? (c = s, u = !0) : (a = s.create(e).injector, h = s, c = a.get(oe, [], { optional: !0, self: !0 }).flat()), { routes: c.map(ur), injector: a, factory: h }; }); }
function _o(t) { return t && typeof t == "object" && "default" in t; }
function fn(t) { return _o(t) ? t.default : t; }
...
var Po = () => { }, bt = new ne(""), It = (() => { class t {
    ...
    lastSuccessfulNavigation = Cr(null);
    events = new Pt;
...
function xo(t) { let n = t; n && n.componentRef && n.componentRef.destroy(); }
var yn = (() => { class t {
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = y.\u0275\u0275defineInjectable({ token: t, factory: () => g(jo), providedIn: "root" });
} return t; })(), Rt = class {
...
} return t; })(), ko = (() => { class t extends Te {
    currentPageId = 0;
    lastSuccessfulId = -1;
...
var H = (() => { class t {
    ...
    parseUrl(e) { try {
        ...
        return this.console.warn(ti(4018, !1)), this.urlSerializer.parse("/");
    } }
...
var la = (() => { class t {
    ...
    el;
    locationStrategy;
    hrefAttributeValue = C(new Go("href"), { optional: !0 });
    ...
    options = C(X, { optional: !0 });
    reactiveRouterState = C(la);
    ...
    static \u0275fac = function (r) { return new (r || t)(d.\u0275\u0275directiveInject(H), d.\u0275\u0275directiveInject(Q), d.\u0275\u0275injectAttribute("tabindex"), d.\u0275\u0275directiveInject(d.Renderer2), d.\u0275\u0275directiveInject(d.ElementRef), d.\u0275\u0275directiveInject(Cn.LocationStrategy)); };
    ...
    isLinkActive(e) { let r = ha(this.routerLinkActiveOptions) ? this.routerLinkActiveOptions : this.routerLinkActiveOptions.exact ?? !1 ? l({}, tr) : l({}, je); return i => { let o = i.urlTree; return o ? _(rr(o, e, r)) : !1; }; }
    hasActiveLinks() { let e = this.isLinkActive(this.router); return this.link && e(this.link) || this.links.some(e); }
    static \u0275fac = function (r) { return new (r || t)(d.\u0275\u0275directiveInject(H), d.\u0275\u0275directiveInject(d.ElementRef), d.\u0275\u0275directiveInject(d.Renderer2), d.\u0275\u0275directiveInject(d.ChangeDetectorRef)); };
...
function ha(t) { let n = t; return !!(n.paths || n.matrixParams || n.queryParams || n.fragment); }
var We = class {
}, fa = (() => { class t {
    preload(e, r) { return r().pipe(aa(() => ae(null))); }
    static \u0275fac = function (r) { return new (r || t); };
    static \u0275prov = d.\u0275\u0275defineInjectable({ token: t, factory: t.\u0275fac, providedIn: "root" });
} return t; })(), pa = (() => { class t {
    ...
    preloadConfig(e, r) { return this.preloadingStrategy.preload(r, () => { if (e.destroyed)
        return ae(null); let i; r.loadChildren && r.canLoad === void 0 ? i = At(this.loader.loadChildren(e, r)) : i = ae(null); let o = i.pipe(ua(s => s === null ? ae(void 0) : (r._loadedRoutes = s.routes, r._loadedInjector = s.injector, r._loadedNgModuleFactory = s.factory, this.processRoutes(s.injector ?? e, s.routes)))); if (r.loadComponent && !r._loadedComponent) {
...
var ga = (() => { class t extends Te {
    ...
    constructor() { super(); let e = r => { this.handleNavigate(r); }; this.navigation.addEventListener("navigate", e), C(ea).onDestroy(() => this.navigation.removeEventListener("navigate", e)); }
...
function Sa(t) { return x(5, [{ provide: X, useValue: t }]); }
function wa() { return x(6, [{ provide: mr, useClass: bn }]); }
function ba(t) { return x(7, [{ provide: bt, useValue: t }]); }
...
function Rs(t) { return t.map(n => (...e) => Ke(n).canMatch(...e)); }
