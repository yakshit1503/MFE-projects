import { a as Rt, b as Ot, c as Pt, d as U, e as Bt, f as Nt, g as kt, h as xt } from "@nf-internal/chunk-DOT4ATRE";
...
import { Subject as zt } from "rxjs";
function X(e, i) { return e ? i ? e.endsWith("/") ? i.startsWith("/") ? e + i.slice(1) : e + i : i.startsWith("/") ? e + i : `${e}/${i}` : e : i; }
function xe(e) { let i = e.search(/#|\?|$/); return e[i - 1] === "/" ? e.slice(0, i - 1) + e.slice(i) : e; }
function S(e) { return e && e[0] !== "?" ? `?${e}` : e; }
var B = (() => { class e {
    historyGo(t) { throw new Error(""); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: () => Ue(J), providedIn: "root" });
} return e; })(), q = new $t(""), J = (() => { class e extends B {
    _platformLocation;
    _baseHref;
    _removeListenerFns = [];
    constructor(t, n) { super(), this._platformLocation = t, this._baseHref = n ?? this._platformLocation.getBaseHrefFromDOM() ?? Ue(Ut).location?.origin ?? ""; }
    ...
    static \u0275fac = function (n) { return new (n || e)(_.\u0275\u0275inject(U), _.\u0275\u0275inject(q, 8)); };
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })(), Vt = (() => { class e extends J {
    prepareExternalUrl(t) { let n = je(t); return n.endsWith("/") && n.length > 1 && (t = n.slice(0, -1) + t.slice(n.length)), super.prepareExternalUrl(t); }
    static \u0275fac = (() => { let t; return function (r) { return (t || (t = _.\u0275\u0275getInheritedFactory(e)))(r || e); }; })();
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })(), Ht = (() => { class e extends J {
    prepareExternalUrl(t) { let n = je(t); return n.endsWith("/") || (t = n + "/" + t.slice(n.length)), super.prepareExternalUrl(t); }
    static \u0275fac = (() => { let t; return function (r) { return (t || (t = _.\u0275\u0275getInheritedFactory(e)))(r || e); }; })();
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac, providedIn: "root" });
} return e; })();
function je(e) { let i = e.search(/[?#]/), t = i > -1 ? i : e.length; return e.slice(0, t); }
var De = (() => { class e {
    _subject = new zt;
    _basePath;
    _locationStrategy;
    ...
    constructor(t) { this._locationStrategy = t; let n = this._locationStrategy.getBaseHref(); this._basePath = Zt(xe($e(n))), this._locationStrategy.onPopState(r => { this._subject.next({ url: this.path(!0), pop: !0, state: r.state, type: r.type }); }); }
    ...
    normalize(t) { return e.stripTrailingSlash(Wt(this._basePath, $e(t))); }
    ...
    static stripTrailingSlash = xe;
    static \u0275fac = function (n) { return new (n || e)(_.\u0275\u0275inject(B)); };
    static \u0275prov = _.\u0275\u0275defineInjectable({ token: e, factory: () => Gt(), providedIn: "root" });
} return e; })();
function Gt() { return new De(jt(B)); }
function Wt(e, i) { if (!e || !i.startsWith(e))
    return i; let t = i.substring(e.length); return t === "" || ["/", ";", "?", "#"].includes(t[0]) ? t : i; }
function $e(e) { return e.replace(/\/index.html$/, ""); }
function Zt(e) { if (new RegExp("^(https?:)?//").test(e)) {
    let [, t] = e.split(/\/\/[^\/]+/);
    return t;
} return e; }
import * as a from "@angular/core";
import { \u0275getLocalePluralCase as Yt, \u0275getLocaleCurrencyCode as Kt, \u0275findLocaleData as y, \u0275LocaleDataIndex as f, \u0275RuntimeError as v, \u0275formatRuntimeError as tr, LOCALE_ID as x, inject as Se, createNgModule as Xt, NgModuleRef as qt, RendererStyleFlags2 as Jt, Injector as Qt, isSignal as ar, \u0275INTERNAL_APPLICATION_ERROR_HANDLER as en, \u0275isPromise as tn, \u0275isSubscribable as nn, untracked as ze, InjectionToken as Xe, DEFAULT_CURRENCY_CODE as rn } from "@angular/core";
...
function b(e, i) { let t = y(e), n = t[f.NumberSymbols][i]; if (typeof n > "u") {
    if (i === m.CurrencyDecimal)
        return t[f.NumberSymbols][m.Decimal];
    if (i === m.CurrencyGroup)
        return t[f.NumberSymbols][m.Group];
} return n; }
function ue(e, i) { return y(e)[f.NumberFormats][i]; }
function un(e) { return y(e)[f.CurrencySymbol] || null; }
function cn(e) { return y(e)[f.CurrencyName] || null; }
function dn(e) { return Kt(e); }
function ln(e) { return y(e)[f.Currencies]; }
var rt = Yt;
function st(e) { if (!e[f.ExtraData])
    throw new v(2303, !1); }
function ot(e) { let i = y(e); return st(i), (i[f.ExtraData][2] || []).map(n => typeof n == "string" ? pe(n) : [pe(n[0]), pe(n[1])]); }
function at(e, i, t) { let n = y(e); st(n); let r = [n[f.ExtraData][0], n[f.ExtraData][1]], s = I(r, i) || []; return I(s, t) || []; }
function fn(e) { return y(e)[f.Directionality]; }
function I(e, i) { for (let t = i; t > -1; t--)
    if (typeof e[t] < "u")
        return e[t]; throw new v(2304, !1); }
function pe(e) { let [i, t] = e.split(":"); return { hours: +i, minutes: +t }; }
function ut(e, i, t = "en") { let n = ln(t)[e] || qe[e] || [], r = n[1]; return i === "narrow" && typeof r == "string" ? r : n[0] || e; }
var hn = 2;
function ct(e) { let i, t = qe[e]; return t && (i = t[2]), typeof i == "number" ? i : hn; }
var gn = /^(\d{4,})-?(\d\d)-?(\d\d)(?:T(\d\d)(?::?(\d\d)(?::?(\d\d)(?:\.(\d+))?)?)?(Z|([+-])(\d\d):?(\d\d))?)?$/, Q = {}, Dn = /((?:[^BEGHLMOSWYZabcdhmswyz']+)|(?:'(?:[^']|'')*')|(?:G{1,5}|y{1,4}|Y{1,4}|M{1,5}|L{1,5}|w{1,2}|W{1}|d{1,2}|E{1,6}|c{1,6}|a{1,5}|b{1,5}|B{1,5}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|S{1,3}|z{1,4}|Z{1,5}|O{1,4}))([\s\S]*)/;
function dt(e, i, t, n) { let r = Sn(e); i = T(t, i) || i; let o = [], u; for (; i;)
    if (u = Dn.exec(i), u) {
        ...
        o.push(i);
        break;
    } let D = r.getTimezoneOffset(); n && (D = ft(n, D), r = An(r, n)); let h = ""; return o.forEach(g => { let c = En(g); h += c ? c(r, t, D) : g === "''" ? "'" : g.replace(/(^'|'$)/g, "").replace(/''/g, "'"); }), h; }
function re(e, i, t) { let n = new Date(0); return n.setFullYear(e, i, t), n.setHours(0, 0, 0), n; }
function T(e, i) { let t = Qe(e); if (Q[t] ??= {}, Q[t][i])
    return Q[t][i]; let n = ""; switch (i) {
    case "shortDate":
        n = j(e, A.Short);
        break;
    case "mediumDate":
    ...
    case "short":
        ...
        n = ee(V(e, A.Short), [r, s]);
        break;
    case "medium":
        let o = T(e, "mediumTime"), u = T(e, "mediumDate");
        n = ee(V(e, A.Medium), [o, u]);
        break;
    case "long":
...
function ee(e, i) { return i && (e = e.replace(/\{([^}]+)}/g, function (t, n) { return i != null && n in i ? i[n] : t; })), e; }
function M(e, i, t = "-", n, r) { let s = ""; (e < 0 || r && e <= 0) && (r ? e = -e + 1 : (e = -e, s = t)); let o = String(e); for (; o.length < i;)
    o = "0" + o; return n && (o = o.slice(o.length - i)), s + o; }
function pn(e, i) { return M(e, 3).substring(0, i); }
function C(e, i, t = 0, n = !1, r = !1) { return function (s, o) { let u = mn(e, s); if ((t > 0 || u > -t) && (u += t), e === 3)
    u === 0 && t === -12 && (u = 12);
else if (e === 6)
    return pn(u, i); let D = b(o, m.MinusSign); return M(u, i, D, n, r); }; }
function mn(e, i) { switch (e) {
    ...
    default: throw new v(2301, !1);
} }
function l(e, i, t = E.Format, n = !1) { return function (r, s) { return Cn(r, s, e, i, t, n); }; }
function Cn(e, i, t, n, r, s) { switch (t) {
    case 2: return nt(i, r, n)[e.getMonth()];
    case 1: return tt(i, r, n)[e.getDay()];
    case 0:
        let o = e.getHours(), u = e.getMinutes();
        if (s) {
            let h = ot(i), g = at(i, r, n), c = h.findIndex(F => { if (Array.isArray(F)) {
                let [p, w] = F, $ = o >= p.hours && u >= p.minutes, P = o < w.hours || o === w.hours && u < w.minutes;
                if (p.hours < w.hours) {
                    if ($ && P)
                        return !0;
                }
        ...
        return et(i, r, n)[o < 12 ? 0 : 1];
    case 3: return it(i, n)[e.getFullYear() <= 0 ? 0 : 1];
    default:
        let D = t;
        throw new v(2302, !1);
} }
function te(e) { return function (i, t, n) { let r = -1 * n, s = b(t, m.MinusSign), o = r > 0 ? Math.floor(r / 60) : Math.ceil(r / 60); switch (e) {
    case 0: return (r >= 0 ? "+" : "") + M(o, 2, s) + M(Math.abs(r % 60), 2, s);
    case 1: return "GMT" + (r >= 0 ? "+" : "") + M(o, 1, s);
    case 2: return "GMT" + (r >= 0 ? "+" : "") + M(o, 2, s) + ":" + M(Math.abs(r % 60), 2, s);
    case 3: return n === 0 ? "Z" : (r >= 0 ? "+" : "") + M(o, 2, s) + ":" + M(Math.abs(r % 60), 2, s);
    default: throw new v(2310, !1);
} }; }
var yn = 0, ie = 4;
function Fn(e) { let i = re(e, yn, 1).getDay(); return re(e, 0, 1 + (i <= ie ? ie : ie + 7) - i); }
function lt(e) { let i = e.getDay(), t = i === 0 ? -3 : ie - i; return re(e.getFullYear(), e.getMonth(), e.getDate() + t); }
function me(e, i = !1) { return function (t, n) { let r; if (i) {
    let s = new Date(t.getFullYear(), t.getMonth(), 1).getDay() - 1, o = t.getDate();
    r = 1 + Math.floor((o + s) / 7);
}
else {
    let s = lt(t), o = Fn(s.getFullYear()), u = s.getTime() - o.getTime();
    r = 1 + Math.round(u / 6048e5);
} return M(r, e, b(n, m.MinusSign)); }; }
function ne(e, i = !1) { return function (t, n) { let s = lt(t).getFullYear(); return M(s, e, b(n, m.MinusSign), i); }; }
var Ce = {};
function En(e) { if (Ce[e])
    return Ce[e]; let i; switch (e) {
    case "G":
    case "GG":
    case "GGG":
        i = l(3, d.Abbreviated);
...
function wn(e, i) { return e = new Date(e.getTime()), e.setMinutes(e.getMinutes() + i), e; }
function An(e, i, t) { let r = e.getTimezoneOffset(), s = ft(i, r); return wn(e, -1 * (s - r)); }
function Sn(e) { if (Ve(e))
    ...
    if (n = e.match(gn))
        return _n(n);
} let i = new Date(e); if (!Ve(i))
    throw new v(2311, !1); return i; }
function _n(e) { let i = new Date(0), t = 0, n = 0, r = e[8] ? i.setUTCFullYear : i.setFullYear, s = e[8] ? i.setUTCHours : i.setHours; e[9] && (t = Number(e[9] + e[10]), n = Number(e[9] + e[11])), r.call(i, Number(e[1]), Number(e[2]) - 1, Number(e[3])); let o = Number(e[4] || 0) - t, u = Number(e[5] || 0) - n, D = Number(e[6] || 0), h = Math.floor(parseFloat("0." + (e[7] || 0)) * 1e3); return s.call(i, o, u, D, h), i; }
function Ve(e) { return e instanceof Date && !isNaN(e.valueOf()); }
var bn = /^(\d+)?\.((\d+)(-(\d+))?)?$/, He = 22, se = ".", H = "0", vn = ";", In = ",", ye = "#", Ge = "\xA4", Ln = "%";
function _e(e, i, t, n, r, s, o = !1) { let u = "", D = !1; if (!isFinite(e))
    u = b(t, m.Infinity);
else {
    let h = Tn(e);
    o && (h = Mn(h));
    ...
    if (s) {
        ...
        if (k === null)
            throw new v(2306, !1);
        let Ne = k[1], ge = k[3], ke = k[5];
        Ne != null && (g = Fe(Ne)), ge != null && (c = Fe(ge)), ke != null ? F = Fe(ke) : ge != null && c > F && (F = c);
    }
    Rn(h, c, F);
    let p = h.digits, w = h.integerLen, $ = h.exponent, P = [];
    ...
    p.length && Z.unshift(p.join("")), u = Z.join(b(t, n)), P.length && (u += b(t, r) + P.join("")), $ && (u += b(t, m.Exponential) + "+" + $);
} return e < 0 && !D ? u = i.negPre + u + i.negSuf : u = i.posPre + u + i.posSuf, u; }
function ht(e, i, t, n, r) { let s = ue(i, W.Currency), o = be(s, b(i, m.MinusSign)); return o.minFrac = ct(n), o.maxFrac = o.minFrac, _e(e, o, i, m.CurrencyGroup, m.CurrencyDecimal, r).replace(Ge, t).replace(Ge, "").trim(); }
function gt(e, i, t) { let n = ue(i, W.Percent), r = be(n, b(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t, !0).replace(new RegExp(Ln, "g"), b(i, m.PercentSign)); }
function Dt(e, i, t) { let n = ue(i, W.Decimal), r = be(n, b(i, m.MinusSign)); return _e(e, r, i, m.Group, m.Decimal, t); }
function be(e, i = "-") { let t = { minInt: 1, minFrac: 0, maxFrac: 0, posPre: "", posSuf: "", negPre: "", negSuf: "", gSize: 0, lgSize: 0 }, n = e.split(vn), r = n[0], s = n[1], o = r.indexOf(se) !== -1 ? r.split(se) : [r.substring(0, r.lastIndexOf(H) + 1), r.substring(r.lastIndexOf(H) + 1)], u = o[0], D = o[1] || ""; t.posPre = u.substring(0, u.indexOf(ye)); for (let g = 0; g < D.length; g++) {
    let c = D.charAt(g);
    c === H ? t.minFrac = t.maxFrac = g + 1 : c === ye ? t.maxFrac = g + 1 : t.posSuf += c;
} let h = u.split(In); if (t.gSize = h[1] ? h[1].length : 0, t.lgSize = h[2] || h[1] ? (h[2] || h[1]).length : 0, s) {
    let g = r.length - t.posPre.length - t.posSuf.length, c = s.indexOf(ye);
    t.negPre = s.substring(0, c).replace(/'/g, ""), t.negSuf = s.slice(c + g).replace(/'/g, "");
}
else
    t.negPre = i + t.posPre, t.negSuf = t.posSuf; return t; }
function Mn(e) { if (e.digits[0] === 0)
...
function Tn(e) { let i = Math.abs(e) + "", t = 0, n, r, s, o, u; for ((r = i.indexOf(se)) > -1 && (i = i.replace(se, "")), (s = i.search(/e/i)) > 0 ? (r < 0 && (r = s), r += +i.slice(s + 1), i = i.substring(0, s)) : r < 0 && (r = i.length), s = 0; i.charAt(s) === H; s++)
    ; if (s === (u = i.length))
    n = [0], r = 1;
else {
    for (u--; i.charAt(u) === H;)
...
function Rn(e, i, t) { if (i > t)
    throw new v(2307, !1); let n = e.digits, r = n.length - e.integerLen, s = Math.min(Math.max(i, r), t), o = s + e.integerLen, u = n[o]; if (o > 0) {
...
function Fe(e) { let i = parseInt(e); if (isNaN(i))
    throw new v(2305, !1); return i; }
var ce = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: () => new mt(Se(x)), providedIn: "root" });
} return e; })();
function pt(e, i, t, n) { let r = `=${e}`; if (i.indexOf(r) > -1 || (r = t.getPluralCategory(e, n), i.indexOf(r) > -1))
    return r; if (i.indexOf("other") > -1)
    return "other"; throw new v(2308, !1); }
var mt = (() => { class e extends ce {
    locale;
    constructor(t) { super(), this.locale = t; }
    getPluralCategory(t, n) { switch (rt(n || this.locale)(t)) {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275inject(x)); };
    static \u0275prov = a.\u0275\u0275defineInjectable({ token: e, factory: e.\u0275fac });
} return e; })(), Ee = /\s+/, We = [], On = (() => { class e {
    _ngEl;
    _renderer;
    initialClasses = We;
    rawClass;
    ...
    set klass(t) { this.initialClasses = t != null ? t.trim().split(Ee) : We; }
    set ngClass(t) { this.rawClass = typeof t == "string" ? t.trim().split(Ee) : t; }
    ...
    ngOnChanges(t) { if (this._needToReCreateComponentInstance(t) && (this._viewContainerRef.clear(), this._inputsUsed.clear(), this._componentRef = void 0, this.ngComponentOutlet)) {
        ...
        this._needToReCreateNgModuleInstance(t) && (this._moduleRef?.destroy(), this.ngComponentOutletNgModule ? this._moduleRef = Xt(this.ngComponentOutletNgModule, Bn(n)) : this._moduleRef = void 0), this._componentRef = this._viewContainerRef.createComponent(this.ngComponentOutlet, { injector: n, ngModuleRef: this._moduleRef, projectableNodes: this.ngComponentOutletContent, environmentInjector: this.ngComponentOutletEnvironmentInjector });
    } }
...
function Bn(e) { return e.get(qt).injector; }
var oe = class {
    $implicit;
    ngForOf;
    index;
    ...
    _applyChanges(t) { let n = this._viewContainer; t.forEachOperation((r, s, o) => { if (r.previousIndex == null)
        n.createEmbeddedView(this._template, new oe(r.item, this._ngForOf, -1, -1), o === null ? void 0 : o);
    else if (o == null)
    ...
    } t.forEachIdentityChange(r => { let s = n.get(r.currentIndex); Ze(s, r); }); }
...
function Ze(e, i) { e.context.$implicit = i.item; }
var Nn = (() => { class e {
    _viewContainer;
    _context = new ae;
    ...
    set ngIfThen(t) { Ye(t, !1), this._thenTemplateRef = t, this._thenViewRef = null, this._updateView(); }
    set ngIfElse(t) { Ye(t, !1), this._elseTemplateRef = t, this._elseViewRef = null, this._updateView(); }
...
function Ye(e, i) { if (e && !e.createEmbeddedView)
    throw new v(2020, !1); }
var G = class {
    _viewContainerRef;
    _templateRef;
    ...
    _view;
    ngSwitchCase;
    constructor(t, n, r) { this.ngSwitch = r, r._addCase(), this._view = new G(t, n); }
    ngDoCheck() { this._view.enforceState(this.ngSwitch._matchCase(this.ngSwitchCase)); }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(ve, 9)); };
    static \u0275dir = a.\u0275\u0275defineDirective({ type: e, selectors: [["", "ngSwitchCase", ""]], inputs: { ngSwitchCase: "ngSwitchCase" } });
} return e; })(), xn = (() => { class e {
    constructor(t, n, r) { r._addDefault(new G(t, n)); }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(ve, 9)); };
...
var yt = (() => { class e {
    ...
    _updateView(t) { this._clearViews(); let n = Object.keys(this._caseViews), r = pt(t, n, this._localization); this._activateView(this._caseViews[r]); }
    _clearViews() { this._activeView && this._activeView.destroy(); }
    _activateView(t) { t && (this._activeView = t, this._activeView.create()); }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(ce)); };
    static \u0275dir = a.\u0275\u0275defineDirective({ type: e, selectors: [["", "ngPlural", ""]], inputs: { ngPlural: "ngPlural" } });
} return e; })(), $n = (() => { class e {
    value;
    constructor(t, n, r, s) { this.value = t; let o = !isNaN(Number(t)); s.addCase(o ? `=${t}` : t, new G(r, n)); }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275injectAttribute("ngPluralCase"), a.\u0275\u0275directiveInject(a.TemplateRef), a.\u0275\u0275directiveInject(a.ViewContainerRef), a.\u0275\u0275directiveInject(yt, 1)); };
    ...
    _setStyle(t, n) { let [r, s] = t.split("."), o = r.indexOf("-") === -1 ? void 0 : Jt.DashCase; n != null ? this._renderer.setStyle(this._ngEl.nativeElement, r, s ? `${n}${s}` : n, o) : this._renderer.removeStyle(this._ngEl.nativeElement, r, o); }
...
function R(e, i) { return new v(2100, !1); }
var we = class {
    createSubscription(i, t, n) { return ze(() => i.subscribe({ next: t, error: n })); }
    dispose(i) { ze(() => i.unsubscribe()); }
}, Ae = class {
    createSubscription(i, t, n) { return i.then(r => t?.(r), r => n?.(r)), { unsubscribe: () => { t = null, n = null; } }; }
    dispose(i) { i.unsubscribe(); }
}, zn = new Ae, Vn = new we, Hn = (() => { class e {
    _ref;
    _latestValue = null;
    ...
    _selectStrategy(t) { if (tn(t))
        return zn; if (nn(t))
        return Vn; throw R(e, t); }
    ...
    transform(t) { return t == null ? null : (Ie(e, t), t.toLowerCase()); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "lowercase", type: e, pure: !0 });
} return e; })(), Wn = /(?:[0-9A-Za-z\xAA\xB5\xBA\xC0-\xD6\xD8-\xF6\xF8-\u02C1\u02C6-\u02D1\u02E0-\u02E4\u02EC\u02EE\u0370-\u0374\u0376\u0377\u037A-\u037D\u037F\u0386\u0388-\u038A\u038C\u038E-\u03A1\u03A3-\u03F5\u03F7-\u0481\u048A-\u052F\u0531-\u0556\u0559\u0560-\u0588\u05D0-\u05EA\u05EF-\u05F2\u0620-\u064A\u066E\u066F\u0671-\u06D3\u06D5\u06E5\u06E6\u06EE\u06EF\u06FA-\u06FC\u06FF\u0710\u0712-\u072F\u074D-\u07A5\u07B1\u07CA-\u07EA\u07F4\u07F5\u07FA\u0800-\u0815\u081A\u0824\u0828\u0840-\u0858\u0860-\u086A\u0870-\u0887\u0889-\u088E\u08A0-\u08C9\u0904-\u0939\u093D\u0950\u0958-\u0961\u0971-\u0980\u0985-\u098C\u098F\u0990\u0993-\u09A8\u09AA-\u09B0\u09B2\u09B6-\u09B9\u09BD\u09CE\u09DC\u09DD\u09DF-\u09E1\u09F0\u09F1\u09FC\u0A05-\u0A0A\u0A0F\u0A10\u0A13-\u0A28\u0A2A-\u0A30\u0A32\u0A33\u0A35\u0A36\u0A38\u0A39\u0A59-\u0A5C\u0A5E\u0A72-\u0A74\u0A85-\u0A8D\u0A8F-\u0A91\u0A93-\u0AA8\u0AAA-\u0AB0\u0AB2\u0AB3\u0AB5-\u0AB9\u0ABD\u0AD0\u0AE0\u0AE1\u0AF9\u0B05-\u0B0C\u0B0F\u0B10\u0B13-\u0B28\u0B2A-\u0B30\u0B32\u0B33\u0B35-\u0B39\u0B3D\u0B5C\u0B5D\u0B5F-\u0B61\u0B71\u0B83\u0B85-\u0B8A\u0B8E-\u0B90\u0B92-\u0B95\u0B99\u0B9A\u0B9C\u0B9E\u0B9F\u0BA3\u0BA4\u0BA8-\u0BAA\u0BAE-\u0BB9\u0BD0\u0C05-\u0C0C\u0C0E-\u0C10\u0C12-\u0C28\u0C2A-\u0C39\u0C3D\u0C58-\u0C5A\u0C5D\u0C60\u0C61\u0C80\u0C85-\u0C8C\u0C8E-\u0C90\u0C92-\u0CA8\u0CAA-\u0CB3\u0CB5-\u0CB9\u0CBD\u0CDD\u0CDE\u0CE0\u0CE1\u0CF1\u0CF2\u0D04-\u0D0C\u0D0E-\u0D10\u0D12-\u0D3A\u0D3D\u0D4E\u0D54-\u0D56\u0D5F-\u0D61\u0D7A-\u0D7F\u0D85-\u0D96\u0D9A-\u0DB1\u0DB3-\u0DBB\u0DBD\u0DC0-\u0DC6\u0E01-\u0E30\u0E32\u0E33\u0E40-\u0E46\u0E81\u0E82\u0E84\u0E86-\u0E8A\u0E8C-\u0EA3\u0EA5\u0EA7-\u0EB0\u0EB2\u0EB3\u0EBD\u0EC0-\u0EC4\u0EC6\u0EDC-\u0EDF\u0F00\u0F40-\u0F47\u0F49-\u0F6C\u0F88-\u0F8C\u1000-\u102A\u103F\u1050-\u1055\u105A-\u105D\u1061\u1065\u1066\u106E-\u1070\u1075-\u1081\u108E\u10A0-\u10C5\u10C7\u10CD\u10D0-\u10FA\u10FC-\u1248\u124A-\u124D\u1250-\u1256\u1258\u125A-\u125D\u1260-\u1288\u128A-\u128D\u1290-\u12B0\u12B2-\u12B5\u12B8-\u12BE\u12C0\u12C2-\u12C5\u12C8-\u12D6\u12D8-\u1310\u1312-\u1315\u1318-\u135A\u1380-\u138F\u13A0-\u13F5\u13F8-\u13FD\u1401-\u166C\u166F-\u167F\u1681-\u169A\u16A0-\u16EA\u16F1-\u16F8\u1700-\u1711\u171F-\u1731\u1740-\u1751\u1760-\u176C\u176E-\u1770\u1780-\u17B3\u17D7\u17DC\u1820-\u1878\u1880-\u1884\u1887-\u18A8\u18AA\u18B0-\u18F5\u1900-\u191E\u1950-\u196D\u1970-\u1974\u1980-\u19AB\u19B0-\u19C9\u1A00-\u1A16\u1A20-\u1A54\u1AA7\u1B05-\u1B33\u1B45-\u1B4C\u1B83-\u1BA0\u1BAE\u1BAF\u1BBA-\u1BE5\u1C00-\u1C23\u1C4D-\u1C4F\u1C5A-\u1C7D\u1C80-\u1C88\u1C90-\u1CBA\u1CBD-\u1CBF\u1CE9-\u1CEC\u1CEE-\u1CF3\u1CF5\u1CF6\u1CFA\u1D00-\u1DBF\u1E00-\u1F15\u1F18-\u1F1D\u1F20-\u1F45\u1F48-\u1F4D\u1F50-\u1F57\u1F59\u1F5B\u1F5D\u1F5F-\u1F7D\u1F80-\u1FB4\u1FB6-\u1FBC\u1FBE\u1FC2-\u1FC4\u1FC6-\u1FCC\u1FD0-\u1FD3\u1FD6-\u1FDB\u1FE0-\u1FEC\u1FF2-\u1FF4\u1FF6-\u1FFC\u2071\u207F\u2090-\u209C\u2102\u2107\u210A-\u2113\u2115\u2119-\u211D\u2124\u2126\u2128\u212A-\u212D\u212F-\u2139\u213C-\u213F\u2145-\u2149\u214E\u2183\u2184\u2C00-\u2CE4\u2CEB-\u2CEE\u2CF2\u2CF3\u2D00-\u2D25\u2D27\u2D2D\u2D30-\u2D67\u2D6F\u2D80-\u2D96\u2DA0-\u2DA6\u2DA8-\u2DAE\u2DB0-\u2DB6\u2DB8-\u2DBE\u2DC0-\u2DC6\u2DC8-\u2DCE\u2DD0-\u2DD6\u2DD8-\u2DDE\u2E2F\u3005\u3006\u3031-\u3035\u303B\u303C\u3041-\u3096\u309D-\u309F\u30A1-\u30FA\u30FC-\u30FF\u3105-\u312F\u3131-\u318E\u31A0-\u31BF\u31F0-\u31FF\u3400-\u4DBF\u4E00-\uA48C\uA4D0-\uA4FD\uA500-\uA60C\uA610-\uA61F\uA62A\uA62B\uA640-\uA66E\uA67F-\uA69D\uA6A0-\uA6E5\uA717-\uA71F\uA722-\uA788\uA78B-\uA7CA\uA7D0\uA7D1\uA7D3\uA7D5-\uA7D9\uA7F2-\uA801\uA803-\uA805\uA807-\uA80A\uA80C-\uA822\uA840-\uA873\uA882-\uA8B3\uA8F2-\uA8F7\uA8FB\uA8FD\uA8FE\uA90A-\uA925\uA930-\uA946\uA960-\uA97C\uA984-\uA9B2\uA9CF\uA9E0-\uA9E4\uA9E6-\uA9EF\uA9FA-\uA9FE\uAA00-\uAA28\uAA40-\uAA42\uAA44-\uAA4B\uAA60-\uAA76\uAA7A\uAA7E-\uAAAF\uAAB1\uAAB5\uAAB6\uAAB9-\uAABD\uAAC0\uAAC2\uAADB-\uAADD\uAAE0-\uAAEA\uAAF2-\uAAF4\uAB01-\uAB06\uAB09-\uAB0E\uAB11-\uAB16\uAB20-\uAB26\uAB28-\uAB2E\uAB30-\uAB5A\uAB5C-\uAB69\uAB70-\uABE2\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFA6D\uFA70-\uFAD9\uFB00-\uFB06\uFB13-\uFB17\uFB1D\uFB1F-\uFB28\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40\uFB41\uFB43\uFB44\uFB46-\uFBB1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB\uFE70-\uFE74\uFE76-\uFEFC\uFF21-\uFF3A\uFF41-\uFF5A\uFF66-\uFFBE\uFFC2-\uFFC7\uFFCA-\uFFCF\uFFD2-\uFFD7\uFFDA-\uFFDC]|\uD800[\uDC00-\uDC0B\uDC0D-\uDC26\uDC28-\uDC3A\uDC3C\uDC3D\uDC3F-\uDC4D\uDC50-\uDC5D\uDC80-\uDCFA\uDE80-\uDE9C\uDEA0-\uDED0\uDF00-\uDF1F\uDF2D-\uDF40\uDF42-\uDF49\uDF50-\uDF75\uDF80-\uDF9D\uDFA0-\uDFC3\uDFC8-\uDFCF]|\uD801[\uDC00-\uDC9D\uDCB0-\uDCD3\uDCD8-\uDCFB\uDD00-\uDD27\uDD30-\uDD63\uDD70-\uDD7A\uDD7C-\uDD8A\uDD8C-\uDD92\uDD94\uDD95\uDD97-\uDDA1\uDDA3-\uDDB1\uDDB3-\uDDB9\uDDBB\uDDBC\uDE00-\uDF36\uDF40-\uDF55\uDF60-\uDF67\uDF80-\uDF85\uDF87-\uDFB0\uDFB2-\uDFBA]|\uD802[\uDC00-\uDC05\uDC08\uDC0A-\uDC35\uDC37\uDC38\uDC3C\uDC3F-\uDC55\uDC60-\uDC76\uDC80-\uDC9E\uDCE0-\uDCF2\uDCF4\uDCF5\uDD00-\uDD15\uDD20-\uDD39\uDD80-\uDDB7\uDDBE\uDDBF\uDE00\uDE10-\uDE13\uDE15-\uDE17\uDE19-\uDE35\uDE60-\uDE7C\uDE80-\uDE9C\uDEC0-\uDEC7\uDEC9-\uDEE4\uDF00-\uDF35\uDF40-\uDF55\uDF60-\uDF72\uDF80-\uDF91]|\uD803[\uDC00-\uDC48\uDC80-\uDCB2\uDCC0-\uDCF2\uDD00-\uDD23\uDE80-\uDEA9\uDEB0\uDEB1\uDF00-\uDF1C\uDF27\uDF30-\uDF45\uDF70-\uDF81\uDFB0-\uDFC4\uDFE0-\uDFF6]|\uD804[\uDC03-\uDC37\uDC71\uDC72\uDC75\uDC83-\uDCAF\uDCD0-\uDCE8\uDD03-\uDD26\uDD44\uDD47\uDD50-\uDD72\uDD76\uDD83-\uDDB2\uDDC1-\uDDC4\uDDDA\uDDDC\uDE00-\uDE11\uDE13-\uDE2B\uDE80-\uDE86\uDE88\uDE8A-\uDE8D\uDE8F-\uDE9D\uDE9F-\uDEA8\uDEB0-\uDEDE\uDF05-\uDF0C\uDF0F\uDF10\uDF13-\uDF28\uDF2A-\uDF30\uDF32\uDF33\uDF35-\uDF39\uDF3D\uDF50\uDF5D-\uDF61]|\uD805[\uDC00-\uDC34\uDC47-\uDC4A\uDC5F-\uDC61\uDC80-\uDCAF\uDCC4\uDCC5\uDCC7\uDD80-\uDDAE\uDDD8-\uDDDB\uDE00-\uDE2F\uDE44\uDE80-\uDEAA\uDEB8\uDF00-\uDF1A\uDF40-\uDF46]|\uD806[\uDC00-\uDC2B\uDCA0-\uDCDF\uDCFF-\uDD06\uDD09\uDD0C-\uDD13\uDD15\uDD16\uDD18-\uDD2F\uDD3F\uDD41\uDDA0-\uDDA7\uDDAA-\uDDD0\uDDE1\uDDE3\uDE00\uDE0B-\uDE32\uDE3A\uDE50\uDE5C-\uDE89\uDE9D\uDEB0-\uDEF8]|\uD807[\uDC00-\uDC08\uDC0A-\uDC2E\uDC40\uDC72-\uDC8F\uDD00-\uDD06\uDD08\uDD09\uDD0B-\uDD30\uDD46\uDD60-\uDD65\uDD67\uDD68\uDD6A-\uDD89\uDD98\uDEE0-\uDEF2\uDFB0]|\uD808[\uDC00-\uDF99]|\uD809[\uDC80-\uDD43]|\uD80B[\uDF90-\uDFF0]|[\uD80C\uD81C-\uD820\uD822\uD840-\uD868\uD86A-\uD86C\uD86F-\uD872\uD874-\uD879\uD880-\uD883][\uDC00-\uDFFF]|\uD80D[\uDC00-\uDC2E]|\uD811[\uDC00-\uDE46]|\uD81A[\uDC00-\uDE38\uDE40-\uDE5E\uDE70-\uDEBE\uDED0-\uDEED\uDF00-\uDF2F\uDF40-\uDF43\uDF63-\uDF77\uDF7D-\uDF8F]|\uD81B[\uDE40-\uDE7F\uDF00-\uDF4A\uDF50\uDF93-\uDF9F\uDFE0\uDFE1\uDFE3]|\uD821[\uDC00-\uDFF7]|\uD823[\uDC00-\uDCD5\uDD00-\uDD08]|\uD82B[\uDFF0-\uDFF3\uDFF5-\uDFFB\uDFFD\uDFFE]|\uD82C[\uDC00-\uDD22\uDD50-\uDD52\uDD64-\uDD67\uDD70-\uDEFB]|\uD82F[\uDC00-\uDC6A\uDC70-\uDC7C\uDC80-\uDC88\uDC90-\uDC99]|\uD835[\uDC00-\uDC54\uDC56-\uDC9C\uDC9E\uDC9F\uDCA2\uDCA5\uDCA6\uDCA9-\uDCAC\uDCAE-\uDCB9\uDCBB\uDCBD-\uDCC3\uDCC5-\uDD05\uDD07-\uDD0A\uDD0D-\uDD14\uDD16-\uDD1C\uDD1E-\uDD39\uDD3B-\uDD3E\uDD40-\uDD44\uDD46\uDD4A-\uDD50\uDD52-\uDEA5\uDEA8-\uDEC0\uDEC2-\uDEDA\uDEDC-\uDEFA\uDEFC-\uDF14\uDF16-\uDF34\uDF36-\uDF4E\uDF50-\uDF6E\uDF70-\uDF88\uDF8A-\uDFA8\uDFAA-\uDFC2\uDFC4-\uDFCB]|\uD837[\uDF00-\uDF1E]|\uD838[\uDD00-\uDD2C\uDD37-\uDD3D\uDD4E\uDE90-\uDEAD\uDEC0-\uDEEB]|\uD839[\uDFE0-\uDFE6\uDFE8-\uDFEB\uDFED\uDFEE\uDFF0-\uDFFE]|\uD83A[\uDC00-\uDCC4\uDD00-\uDD43\uDD4B]|\uD83B[\uDE00-\uDE03\uDE05-\uDE1F\uDE21\uDE22\uDE24\uDE27\uDE29-\uDE32\uDE34-\uDE37\uDE39\uDE3B\uDE42\uDE47\uDE49\uDE4B\uDE4D-\uDE4F\uDE51\uDE52\uDE54\uDE57\uDE59\uDE5B\uDE5D\uDE5F\uDE61\uDE62\uDE64\uDE67-\uDE6A\uDE6C-\uDE72\uDE74-\uDE77\uDE79-\uDE7C\uDE7E\uDE80-\uDE89\uDE8B-\uDE9B\uDEA1-\uDEA3\uDEA5-\uDEA9\uDEAB-\uDEBB]|\uD869[\uDC00-\uDEDF\uDF00-\uDFFF]|\uD86D[\uDC00-\uDF38\uDF40-\uDFFF]|\uD86E[\uDC00-\uDC1D\uDC20-\uDFFF]|\uD873[\uDC00-\uDEA1\uDEB0-\uDFFF]|\uD87A[\uDC00-\uDFE0]|\uD87E[\uDC00-\uDE1D]|\uD884[\uDC00-\uDF4A])\S*/g, Zn = (() => { class e {
    transform(t) { return t == null ? null : (Ie(e, t), t.replace(Wn, n => n[0].toUpperCase() + n.slice(1).toLowerCase())); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "titlecase", type: e, pure: !0 });
} return e; })(), Yn = (() => { class e {
    transform(t) { return t == null ? null : (Ie(e, t), t.toUpperCase()); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "uppercase", type: e, pure: !0 });
} return e; })();
function Ie(e, i) { if (typeof i != "string")
    throw R(e, i); }
var Kn = "mediumDate", Ft = new Xe(""), Et = new Xe(""), Xn = (() => { class e {
    locale;
    defaultTimezone;
    defaultOptions;
    ...
    transform(t, n, r, s) { if (t == null || t === "" || t !== t)
        return null; try {
        let o = n ?? this.defaultOptions?.dateFormat ?? Kn, u = r ?? this.defaultOptions?.timezone ?? this.defaultTimezone ?? void 0;
        return dt(t, o, s || this.locale, u);
    }
    catch (o) {
        throw R(e, o.message);
    } }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(Ft, 24), a.\u0275\u0275directiveInject(Et, 24)); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "date", type: e, pure: !0 });
} return e; })(), qn = /#/g, Jn = (() => { class e {
    _localization;
    constructor(t) { this._localization = t; }
    transform(t, n, r) { if (t == null)
        return ""; if (typeof n != "object" || n === null)
        throw R(e, n); let s = pt(t, Object.keys(n), this._localization, r); return n[s].replace(qn, t.toString()); }
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(ce, 16)); };
...
function ti(e, i) { return { key: e, value: i }; }
var ni = (() => { class e {
    differs;
    ...
    keyValues = [];
    compareFn = Ke;
    transform(t, n = Ke) { if (!t || !(t instanceof Map) && typeof t != "object")
        return null; this.differ ??= this.differs.find(t).create(); let r = this.differ.diff(t), s = n !== this.compareFn; return r && (this.keyValues = [], r.forEachItem(o => { this.keyValues.push(ti(o.key, o.currentValue)); })), (r || s) && (n && this.keyValues.sort(n), this.compareFn = n), this.keyValues; }
...
function Ke(e, i) { let t = e.key, n = i.key; if (t === n)
    return 0; if (t == null)
    return 1; if (n == null)
...
var ii = (() => { class e {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16)); };
    ...
    transform(t, n = this._defaultCurrencyCode, r = "symbol", s, o) { if (!Le(t))
        return null; o ||= this._locale, typeof r == "boolean" && (r = r ? "symbol" : "code"); let u = n || this._defaultCurrencyCode; r !== "code" && (r === "symbol" || r === "symbol-narrow" ? u = ut(u, r === "symbol" ? "wide" : "narrow", o) : u = r); try {
        let D = Me(t);
        return ht(D, o, u, n, s);
    }
    catch (D) {
    ...
    static \u0275fac = function (n) { return new (n || e)(a.\u0275\u0275directiveInject(x, 16), a.\u0275\u0275directiveInject(rn, 16)); };
    static \u0275pipe = a.\u0275\u0275definePipe({ name: "currency", type: e, pure: !0 });
} return e; })();
function Le(e) { return !(e == null || e === "" || e !== e); }
function Me(e) { if (typeof e == "string" && !isNaN(Number(e) - parseFloat(e)))
    return Number(e); if (typeof e != "number")
    throw new v(2309, !1); return e; }
var oi = (() => { class e {
    transform(t, n, r) { if (t == null)
...
import { inject as L, DestroyRef as vt, \u0275registerLocaleData as di, Version as li, \u0275\u0275defineInjectable as fi, DOCUMENT as It, \u0275formatRuntimeError as hi, InjectionToken as Oe, \u0275RuntimeError as Pe, \u0275IMAGE_CONFIG as gi, Renderer2 as Di, ElementRef as pi, Injector as mi, \u0275performanceMarkFeature as Ci, booleanAttribute as de, numberAttribute as St, ChangeDetectorRef as yi, \u0275IMAGE_CONFIG_DEFAULTS as Fi, \u0275unwrapSafeValue as Ei } from "@angular/core";
import { DOCUMENT as Hr, \u0275IMAGE_CONFIG as Gr } from "@angular/core";
import * as wt from "@angular/core";
import { InjectionToken as ui } from "@angular/core";
var ci = new ui("", { factory: () => typeof window < "u" && typeof window.NavigationPrecommitController < "u" }), At = (() => { class e {
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275prov = wt.\u0275\u0275defineInjectable({ token: e, factory: () => window.navigation, providedIn: "platform" });
} return e; })();
import "rxjs";
var br = (() => { class e extends De {
    navigation = L(At);
    destroyRef = L(vt);
...
function Si(e, i) { let t = e.getElementById(i) || e.getElementsByName(i)[0]; if (t)
...
function _i(e) { return e.endsWith("/") ? e.slice(0, -1) : e; }
function bi(e) { return e.startsWith("/") ? e.slice(1) : e; }
var Tt = e => e.src, Be = new Oe("", { factory: () => Tt });
function fe(e, i) { return function (n) { return Mt(n) || vi(n, i || []), n = _i(n), [{ provide: Be, useValue: o => (Lt(o.src) && Ii(n, o.src), e(n, K(Y({}, o), { src: bi(o.src) }))) }]; }; }
function vi(e, i) { throw new Pe(2959, !1); }
function Ii(e, i) { throw new Pe(2959, !1); }
function he(e, i) { return typeof e == "string" ? e : Object.entries(e).map(([t, n]) => `${t}${i}${n}`).join(","); }
var Rr = fe(Li, void 0);
function Li(e, i) { let t = "format=auto"; if (i.width && (t += `,width=${i.width}`), i.height && (t += `,height=${i.height}`), i.isPlaceholder && (t += `,quality=${le}`), i.loaderParams?.transform) {
    let n = he(i.loaderParams.transform, "=");
    t += `,${n}`;
} return `${e}/cdn-cgi/image/${t}/${i.src}`; }
var Or = fe(Mi, void 0);
function Mi(e, i) { let n = `f_auto,${i.isPlaceholder ? "q_auto:low" : "q_auto"}`; if (i.width && (n += `,w_${i.width}`), i.height && (n += `,h_${i.height}`), i.loaderParams?.rounded && (n += ",r_max"), i.loaderParams?.transform) {
    let r = he(i.loaderParams.transform, "_");
    n += `,${r}`;
} return `${e}/image/upload/${n}/${i.src}`; }
var Pr = fe(Ti, void 0);
function Ti(e, i) { let { src: t, width: n } = i, r = []; if (n && r.push(`w-${n}`), i.height && r.push(`h-${i.height}`), i.isPlaceholder && r.push(`q-${le}`), i.loaderParams?.transform) {
    let u = he(i.loaderParams.transform, "-");
    r.push(u);
} let s = r.length ? [e, `tr:${r.join(",")}`, t] : [e, t]; return new URL(s.join("/")).href; }
var Br = fe(Ri, void 0);
function Ri(e, i) { let t = []; if (t.push("auto=format"), i.width && t.push(`w=${i.width}`), i.height && t.push(`h=${i.height}`), i.isPlaceholder && t.push(`q=${le}`), i.loaderParams?.transform) {
    let r = he(i.loaderParams.transform, "=").split(",");
    t.push(...r);
} let n = new URL(`${e}/${i.src}`); return n.search = t.join("&"), n.href; }
function Nr(e) { if (e && !Mt(e))
    throw new Pe(2959, !1); return e && (e = new URL(e).origin), [{ provide: Be, useValue: n => Oi(n, e) }]; }
var _t = new Map([["height", "h"], ["fit", "fit"], ["quality", "q"], ["q", "q"], ["position", "position"]]);
function Oi(e, i) { let t = new URL(i ?? "https://a/"); t.pathname = "/.netlify/images", !Lt(e.src) && !e.src.startsWith("/") && (e.src = "/" + e.src), t.searchParams.set("url", e.src), e.width && t.searchParams.set("w", e.width.toString()), e.height && t.searchParams.set("h", e.height.toString()); let n = e.loaderParams?.quality ?? e.loaderParams?.q; e.isPlaceholder && !n && t.searchParams.set("q", le); for (let [r, s] of Object.entries(e.loaderParams ?? {}))
    _t.has(r) && t.searchParams.set(_t.get(r), s.toString()); return t.hostname === "a" ? t.href.replace(t.origin, "") : t.href; }
var kr = new Oe("");
var Pi = new Oe("", { factory: () => new Set }), Bi = (() => { class e {
    preloadedImages = L(Pi);
    document = L(It);
    errorShown = !1;
...
var xr = (() => { class e {
    ...
    ngOnInit() { Ci("NgOptimizedImage"), this.placeholder && this.removePlaceholderOnLoad(this.imgElement), this.setHostAttributes(); }
    setHostAttributes() { this.fill ? this.sizes ||= "100vw" : (this.setHostAttribute("width", this.width.toString()), this.setHostAttribute("height", this.height.toString())), this.setHostAttribute("loading", this.getLoadingBehavior()), this.setHostAttribute("fetchpriority", this.getFetchPriority()), this.setHostAttribute("decoding", this.getDecoding()), this.setHostAttribute("ng-img", "true"); let t = this.updateSrcAndSrcset(); this.sizes ? this.getLoadingBehavior() === "lazy" ? this.setHostAttribute("sizes", "auto, " + this.sizes) : this.setHostAttribute("sizes", this.sizes) : this.ngSrcset && bt.test(this.ngSrcset) && this.getLoadingBehavior() === "lazy" && this.setHostAttribute("sizes", "auto, 100vw"), typeof ngServerMode < "u" && ngServerMode && this.priority && this.injector.get(Bi).createPreloadLinkTag(this.renderer, this.getRewrittenSrc(), t, this.sizes); }
    ...
    getRewrittenSrcset() { let t = bt.test(this.ngSrcset); return this.ngSrcset.split(",").filter(r => r !== "").map(r => { r = r.trim(); let s = t ? parseFloat(r) : parseFloat(r) * this.width; return `${this.callImageLoader({ src: this.ngSrc, width: s })} ${r}`; }).join(", "); }
    getAutomaticSrcset() { return this.sizes ? this.getResponsiveSrcset() : this.getFixedSrcset(); }
    getResponsiveSrcset() { let { breakpoints: t } = this.config, n = t; return this.sizes?.trim() === "100vw" && (n = t.filter(s => s >= ki)), n.map(s => `${this.callImageLoader({ src: this.ngSrc, width: s })} ${s}w`).join(", "); }
    ...
    getFixedSrcset() { return Ni.map(n => `${this.callImageLoader({ src: this.ngSrc, width: this.width * n })} ${n}x`).join(", "); }
    shouldGenerateAutomaticSrcset() { let t = !1; return this.sizes || (t = this.width > xi || this.height > $i), !this.disableOptimizedSrcset && !this.srcset && this.imageLoader !== Tt && !t; }
    ...
    removePlaceholderOnLoad(t) { let n = () => { let o = this.injector.get(yi); r(), s(), this.placeholder = !1, o.markForCheck(); }, r = this.renderer.listen(t, "load", n), s = this.renderer.listen(t, "error", n); this.destroyRef.onDestroy(() => { r(), s(); }), ji(t, n); }
    setHostAttribute(t, n) { this.renderer.setAttribute(this.imgElement, t, n); }
    static \u0275fac = function (n) { return new (n || e); };
    static \u0275dir = O.\u0275\u0275defineDirective({ type: e, selectors: [["img", "ngSrc", ""]], hostVars: 18, hostBindings: function (n, r) { n & 2 && O.\u0275\u0275styleProp("position", r.fill ? "absolute" : null)("width", r.fill ? "100%" : null)("height", r.fill ? "100%" : null)("inset", r.fill ? "0" : null)("background-size", r.placeholder ? "cover" : null)("background-position", r.placeholder ? "50% 50%" : null)("background-repeat", r.placeholder ? "no-repeat" : null)("background-image", r.placeholder ? r.generatePlaceholder(r.placeholder) : null)("filter", r.placeholder && r.shouldBlurPlaceholder(r.placeholderConfig) ? "blur(15px)" : null); }, inputs: { ngSrc: [2, "ngSrc", "ngSrc", zi], ngSrcset: "ngSrcset", sizes: "sizes", width: [2, "width", "width", St], height: [2, "height", "height", St], decoding: "decoding", loading: "loading", priority: [2, "priority", "priority", de], loaderParams: "loaderParams", disableOptimizedSrcset: [2, "disableOptimizedSrcset", "disableOptimizedSrcset", de], fill: [2, "fill", "fill", de], placeholder: [2, "placeholder", "placeholder", Vi], placeholderConfig: "placeholderConfig", src: "src", srcset: "srcset" }, features: [O.\u0275\u0275NgOnChangesFeature] });
} return e; })();
function Ui(e) { let i = {}; return e.breakpoints && (i.breakpoints = e.breakpoints.sort((t, n) => t - n)), Object.assign({}, Fi, e, i); }
function ji(e, i) { e.complete && e.naturalWidth && i(); }
function zi(e) { return typeof e == "string" ? e : Ei(e); }
function Vi(e) { return typeof e == "string" && e !== "true" && e !== "false" && e !== "" ? e : de(e); }
export { q as APP_BASE_HREF, Hn as AsyncPipe, Nt as BrowserPlatformLocation, ai as CommonModule, si as CurrencyPipe, Et as DATE_PIPE_DEFAULT_OPTIONS, Ft as DATE_PIPE_DEFAULT_TIMEZONE, Hr as DOCUMENT, Xn as DatePipe, ii as DecimalPipe, E as FormStyle, A as FormatWidth, sn as HashLocationStrategy, Jn as I18nPluralPipe, Qn as I18nSelectPipe, Gr as IMAGE_CONFIG, Be as IMAGE_LOADER, ei as JsonPipe, ni as KeyValuePipe, Bt as LOCATION_INITIALIZED, De as Location, B as LocationStrategy, Gn as LowerCasePipe, On as NgClass, Pn as NgComponentOutlet, Ct as NgFor, Ct as NgForOf, oe as NgForOfContext, Nn as NgIf, ae as NgIfContext, mt as NgLocaleLocalization, ce as NgLocalization, xr as NgOptimizedImage, yt as NgPlural, $n as NgPluralCase, Un as NgStyle, ve as NgSwitch, kn as NgSwitchCase, xn as NgSwitchDefault, jn as NgTemplateOutlet, Vt as NoTrailingSlashPathLocationStrategy, W as NumberFormatStyle, m as NumberSymbol, kr as PRECONNECT_CHECK_BLOCKLIST, J as PathLocationStrategy, ri as PercentPipe, U as PlatformLocation, At as PlatformNavigation, N as Plural, oi as SlicePipe, Zn as TitleCasePipe, Ht as TrailingSlashPathLocationStrategy, d as TranslationWidth, Yn as UpperCasePipe, Mr as VERSION, Tr as ViewportScroller, Je as WeekDay, xt as XhrFactory, ht as formatCurrency, dt as formatDate, Dt as formatNumber, gt as formatPercent, ut as getCurrencySymbol, dn as getLocaleCurrencyCode, cn as getLocaleCurrencyName, un as getLocaleCurrencySymbol, j as getLocaleDateFormat, V as getLocaleDateTimeFormat, tt as getLocaleDayNames, et as getLocaleDayPeriods, fn as getLocaleDirection, it as getLocaleEraNames, ot as getLocaleExtraDayPeriodRules, at as getLocaleExtraDayPeriods, on as getLocaleFirstDayOfWeek, Qe as getLocaleId, nt as getLocaleMonthNames, ue as getLocaleNumberFormat, b as getLocaleNumberSymbol, rt as getLocalePluralCase, z as getLocaleTimeFormat, an as getLocaleWeekEndRange, ct as getNumberOfCurrencyDigits, Ir as isPlatformBrowser, Lr as isPlatformServer, Rr as provideCloudflareLoader, Or as provideCloudinaryLoader, Pr as provideImageKitLoader, Br as provideImgixLoader, Nr as provideNetlifyLoader, vr as registerLocaleData, Pt as \u0275DomAdapter, br as \u0275NavigationAdapterForLocation, Re as \u0275NullViewportScroller, wi as \u0275PLATFORM_BROWSER_ID, Ai as \u0275PLATFORM_SERVER_ID, ci as \u0275PRECOMMIT_HANDLER_SUPPORTED, Rt as \u0275getDOM, S as \u0275normalizeQueryParams, kt as \u0275parseCookieValue, Ot as \u0275setRootDomAdapter };
